...
{
    public partial class frmLoginP3 : Form
    {
        PopController pop;
        public frmLoginP3()
        {
        ...
        private void frmLoginP3_Load(object sender, EventArgs e)
        {
        ...
        private async void btnLogin_Click(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(txtUser.Text) && !string.IsNullOrEmpty(txtPassword.Text))
            {
                ...
                if (await Authenticated(Constants.Plant3Id, credentials))
                {
                    pop.Close();
                    ...
                    frmSettingsP3 frmSettingsP3 = new frmSettingsP3();
                    frmSettingsP3.StartPosition = FormStartPosition.CenterParent;
                    frmSettingsP3.ShowDialog();
                }
                else
                {
                    pop.Close();
